...
const AddRecipe = props => {
    ...
    const nameValidate = (value) => {
        const validValue = value && value.replace(/\s{2,}/g, ' ')
            ...
            const isError = !value || validValue.length < MIN_NAME_LENGTH
    ...
    const descriptionValidate = value => {
        ...
        const isError = !value || validValue.length < MIN_DESCRIPTION_LENGTH
    ...
    const inputs = [
        ...
        },
        {
            ...
            helperText: 'Zbyt krótka nazwa, minimum 15 znaków',
            multiline: true
